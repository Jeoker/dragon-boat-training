...
var DRAGON_BOAT_PROPERTY_KEYS_ = {
  ...
  BRIDGE_SECRET: "DRAGON_BOAT_BRIDGE_SECRET",
  BRIDGE_TEAM_ID: "DRAGON_BOAT_BRIDGE_TEAM_ID",
  BRIDGE_BINDING_VERSION: "DRAGON_BOAT_BRIDGE_BINDING_VERSION",
  BRIDGE_WRITER_EPOCH: "DRAGON_BOAT_BRIDGE_WRITER_EPOCH",
  BRIDGE_REPLAY_STATE: "DRAGON_BOAT_BRIDGE_REPLAY_STATE"
};
