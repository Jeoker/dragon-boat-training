/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/worker-configuration.d.ts` (hash: f8108c58e0f56a57bd8ebc62c8e64913)
// Runtime types generated with workerd@1.20260918.1 2026-09-19
interface __BaseEnv_Env {
	ENVIRONMENT: "production" | "staging";
	SERVICE_VERSION: "0.1.0-c0";
	CONTRACT_VERSION: "2026-09-19.c0";
	BACKEND_INSTANCE: "dragon-boat-training-production" | "dragon-boat-training-staging";
	BACKEND_GENERATION: "cf-c0-production-1" | "cf-c0-staging-1";
	WRITER_EPOCH: "0";
	TEAM_ID: "pentasus";
	TEAM_STATE: DurableObjectNamespace /* TeamState */;
}
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		SERVICE_VERSION: "0.1.0-c0";
		CONTRACT_VERSION: "2026-09-19.c0";
		BACKEND_INSTANCE: "dragon-boat-training-production";
		BACKEND_GENERATION: "cf-c0-production-1";
		WRITER_EPOCH: "0";
		TEAM_ID: "pentasus";
		TEAM_STATE: DurableObjectNamespace /* TeamState */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SERVICE_VERSION" | "CONTRACT_VERSION" | "BACKEND_INSTANCE" | "BACKEND_GENERATION" | "WRITER_EPOCH" | "TEAM_ID">> {}
}
